...
// TLS fingerprint spoofing (got-scraping / browser-like JA3) was removed:
// it was never a dependency of this package and the code had been disabled in
// favour of native fetch. proxyAwareFetch now always uses native fetch.
...
export async function proxyAwareFetch(url, options = {}, proxyOptions = null) {
  ...
  // Plain host — native fetch (no TLS fingerprint spoofing).
  return originalFetch(url, options);
}
